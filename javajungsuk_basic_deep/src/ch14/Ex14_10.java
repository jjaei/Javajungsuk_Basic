...
class Ex14_10 {
	public static void main(String[] args) {
		...
		Map<Boolean, Map<Boolean, List<Student2>>> failedStudBySex = 
				Stream.of(stuArr).collect(partitioningBy(Student2::isMale,
						partitioningBy(s -> s.getScore() <= 150))); 
		
		List<Student2> failedMale = failedStudBySex.get(true).get(true);
		List<Student2> failedFemale = failedStudBySex.get(false).get(false);
